...
for a in D_u:
    #Starting angle
    dic_u_l['D_in' ].append(calc_angle (jn(vp.data_rot_u, a, a+'_light', 'geometry.in'), atom_ref_u)          +D_off)
    #Relaxed angle
    dic_u_l['D_out'].append(calc_angle (jn(vp.data_rot_u, a, a+'_light', 'geometry.in.next_step'), atom_ref_u)+D_off)
    #Relaxed Energy
...
ax = axs[0]
ax.tick_params(axis='x', bottom=True, top=True, direction='inout', labelbottom=False, labeltop=True, length=10, width=3)
...
ax.legend((shade,line[0]), ('Predicted\nRelaxation','Direct\nRelaxation'),
          loc='center right', bbox_to_anchor=(0.03,0.5), fontsize=15)
...
ax.tick_params(axis='x', bottom=True, top=True, direction='inout', labelbottom=False, labeltop=False, length=10, width=3)
...
ax.tick_params(axis='x', bottom=True, top=True, direction='inout', labelbottom=True, labeltop=False, length=10, width=3)
